@extends('layouts.web', ['title' => 'Forget Password'])
            ...
            <div class="row g-5 justify-content-center">
                <div class="col-lg-6">
                    <div class="login-form-box">
                        <form class="login-form" action="{{ route('forget.password.post') }}" method="POST" id="forget-password-form">
                            ...
                            <div class="input-box text-center">
                                Already have an Account? <a href="{{ route('login') }}" class="lost-password">Login now</a>
                            </div>
                            <div class="input-box mt-2 text-center">
                                New Here? <a href="{{ route('register') }}" class="lost-password">Create an Account.</a>
                            </div>
