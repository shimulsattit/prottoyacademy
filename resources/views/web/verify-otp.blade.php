@extends('layouts.web', ['title' => 'Verify OTP'])
                ...
                <div class="col-lg-12">
                    <div class="breadcrumb-inner text-start">
                        <div class="page-title">
                            ...
                            <p class="lead">We have sent a 6-digit code to your email. Please enter it below to verify your identity. Currently We do not have any email provider right now. Please use the code below to proceed. <b>{{ Session::get('password_reset_code') }}</b></p>
                        </div>
            ...
            <div class="row g-5 justify-content-center">
                <div class="col-lg-6">
                    <div class="login-form-box">
                        <form class="login-form" action="{{ route('verify.otp.post') }}" method="POST" id="verify-otp-form">
                            <div class="input-box mb--30">
                                <input type="text" name="code" id="code" required placeholder="Enter Your OTP" />
                            </div>
