@extends('layouts.admin', ['title' => 'Update Question Tag Information'])
@push('style')
    ...
    <div class="d-flex flex-column flex-column-fluid">
            ...
            <div id="app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">
                        Update Question Tag Information (প্রশ্ন ট্যাগ সংশোধন করুন)
                    </h1>
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <li class="breadcrumb-item text-muted">Update Tag</li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div id="app_content" class="app-content flex-column-fluid">
            <div id="app_content_container" class="app-container container-xxl">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('portal.question-tag.update', $model->id) }}" method="POST" enctype="multipart/form-data" class="content_form">
                            @method('PATCH')
                            <div class="row">
                                ...
                                <div class="col-md-12 form-group mb-3">
                                    ...
                                    <select name="status" id="status" class="form-control select" required>
                                        <option {{ $model->status == 1 ? 'selected' : '' }} value="1">Publish (পাবলিশ)</option>
                                        <option {{ $model->status == 0 ? 'selected' : '' }} value="0">Unpublish (আনপাবলিশ)</option>
                                    </select>
                                </div>
