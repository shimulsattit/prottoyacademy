@extends('layouts.admin', ['title' => 'Update Year Information'])
@push('style')
    ...
    <div class="d-flex flex-column flex-column-fluid">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        @if (Auth::guard('admin')->user()->hasPermissionTo('year.view'))
                            <li class="breadcrumb-item text-muted">
                                <a href="{{ route('portal.year.index') }}" class="text-muted text-hover-primary">Year Management</a>
                            </li>
                        @endif
                        <li class="breadcrumb-item">
                            <span class="bullet bg-gray-500 w-5px h-2px"></span>
                        </li>
                        <li class="breadcrumb-item text-muted">Update Year Information</li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div id="app_content" class="app-content flex-column-fluid">
            <div id="app_content_container" class="app-container container-xxl">
                <div class="card">
                    <div class="card-body">
                        <form data-editor="description" action="{{ route('portal.year.update', $model->uuid) }}" method="POST" enctype="multipart/form-data" class="content_form">
                            @method('PATCH')
                            <div class="row">
                                ...
                                @if (Auth::guard('admin')->user()->hasPermissionTo('year.update'))
                                    <div class="col-md-12 mb-3 text-center">
                                        <button type="submit" class="btn btn-sm btn-block btn-primary" id="submit">
                                            <i class="fas fa-paper-plane fa-fw"></i> Update Year    
                                        </button>
