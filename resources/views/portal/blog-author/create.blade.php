@extends('layouts.admin', ['title' => 'Create New Blog Author'])
@push('style')
    ...
    <div class="d-flex flex-column flex-column-fluid">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <li class="breadcrumb-item">
                            ...
                            <li class="breadcrumb-item text-muted">
                                <a href="{{ route('portal.blog-author.index') }}" class="text-muted text-hover-primary">Blog Author Management</a>
                            </li>
                        <li class="breadcrumb-item">
                            <span class="bullet bg-gray-500 w-5px h-2px"></span>
                        </li>
                        <li class="breadcrumb-item text-muted">Create New Blog Author</li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div id="app_content" class="app-content flex-column-fluid">
            <div id="app_content_container" class="app-container container-xxl">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('portal.blog-author.store') }}" method="POST" class="content_form" data-editor="content">
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3 form-group">
                                    ...
                                    <input type="text" name="designation" id="designation" class="form-control" required value="">
                                </div>
                                ...
                                <div class="col-md-12 mb-3 form-group">
                                    ...
                                    <input type="file" name="profile_picture" id="profile_picture" class="form-control dropify">
                                </div>
