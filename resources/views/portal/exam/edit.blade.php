@extends('layouts.admin', ['title' => 'Update Exam Information'])
@push('style')
    ...
    <div class="d-flex flex-column flex-column-fluid">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        @if(Auth::guard('admin')->user()->hasPermissionTo('exam.update'))
                            <li class="breadcrumb-item text-muted">
                                <a href="{{ route('portal.exam.index') }}" class="text-muted text-hover-primary">Exam Management</a>
                            </li>
                        @endif
                        <li class="breadcrumb-item">
                            <span class="bullet bg-gray-500 w-5px h-2px"></span>
                        </li>
                        <li class="breadcrumb-item text-muted">Update Exam Information</li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div id="app_content" class="app-content flex-column-fluid">
            <div id="app_content_container" class="app-container container-xxl">
                <div class="card">
                    <div class="card-body">
                        <form data-editor="description" action="{{ route('portal.exam.update', $model->uuid) }}" method="POST" enctype="multipart/form-data" class="content_form">
                            @method('PATCH')
                            <div class="row">
                                ...
                                <div class="col-md-6 form-group mb-3">
                                    ...
                                    <select name="job_category_id" id="job_category_id" class="form-control" required data-parsley-errors-container="#job_category_id_error">
                                        @if ($model->job_category)
                                            <option selected value="{{ $model->job_category->id }}"> {{ $model->job_category->name }}</option>
                                        @endif
                                    </select>
                                ...
                                <div class="col-md-6 form-group mb-3">
                                    ...
                                    <select name="year_id" id="year_id" class="form-control" required data-parsley-errors-container="#year_id">
                                        @if ($model->year)
                                            <option selected value="{{ $model->year->id }}"> {{ $model->year->name }}</option>
                                        @endif
                                    </select>
                                ...
                                <div class="col-md-12 mb-3 form-group">
                                    ...
                                    <input type="text" name="name_in_bangla" id="name_in_bangla" class="form-control" value="{{ $model->name_in_bangla }}">
                                </div>
                                ...
                                @if(Auth::guard('admin')->user()->hasPermissionTo('exam.update'))
                                    <div class="col-md-12 mb-3 text-center">
                                        <button type="submit" class="btn btn-sm btn-block btn-primary" id="submit">
                                            <i class="fas fa-paper-plane fa-fw"></i> Update Exam    
                                        </button>
