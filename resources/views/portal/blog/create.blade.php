@extends('layouts.admin', ['title' => 'Create New Blog'])
@push('style')
    ...
    <div class="d-flex flex-column flex-column-fluid">
            ...
            <div id="app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <li class="breadcrumb-item text-muted">Create New Blog</li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div id="app_content" class="app-content flex-column-fluid">
            <div id="app_content_container" class="app-container container-xxl">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('portal.blog.store') }}" data-editor="content" method="POST" class="content_form">
                            <div class="row">
