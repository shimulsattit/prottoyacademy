        ...
        <div id="app_toolbar" class="app-toolbar py-3 py-lg-6">
            <div id="app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                {{-- <div class="d-flex align-items-center gap-2 gap-lg-3">
                    <a href="javascript:void(0)" class="btn btn-sm fw-bold btn-primary" onclick="">
                        Create
                    </a>
                </div> --}}
            </div>
                    ...
                    <div class="card-body">
                        <div class="row mt-3">
                            ...
                            <div class="col-md-9">
                                <div class="row">
                                    <div class="col-md-12">
                                        <ul style="width: 100%;overflow-x:scroll;" class="list-group list-group-horizontal w-100" id="category-content"></ul>
                                    </div>
                                </div>
                                <div id="question-content" class="p-5">
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '.job-category', function() {
                ...
                let jobCategoryName = $(this).html().trim();
                ...
                $.get(`/portal/quiz/questions/${categoryId}/${jobCategoryId}`, { offset: currentOffset }, function (response) {
                    ...
                    groupedQuestions.forEach((group) => {
                        ...
                        group.groups.forEach((g) => {
                            ...
                            if (hasPassage) {
                                contentHtml += `</div> `; // close .passage-group only if started
                            }
                        });
                });
