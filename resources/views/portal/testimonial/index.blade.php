@extends('layouts.admin', ['title' => 'Testimonial Management', 'modal' => 'lg'])
@push('style')
        ...
        <div id="app_toolbar" class="app-toolbar py-3 py-lg-6">
            <div id="app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="d-flex align-items-center gap-2 gap-lg-3">
                    <a id="content_management" href="javascript:;" data-url="{{ route('portal.testimonial.create') }}" class="btn btn-sm fw-bold btn-primary">
                        Create
                    </a>
                </div>
            </div>
    ...
    <script>
        ...
        $(function () {
            ...
            var table = $('#data-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('portal.testimonial.index') }}",
                columns: [
                    {
                        data: 'id',
                        name: 'id',
