@extends('layouts.admin', ['title' => 'Job Category Management'])
@push('style')
            ...
            <div id="app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <li class="breadcrumb-item text-muted">Job Category Management</li>
                    </ul>
                </div>

                <div class="d-flex align-items-center gap-2 gap-lg-3">
                    @if(Auth::guard('admin')->user()->hasPermissionTo('job_category.create'))
                        <a href="{{ route('portal.job-category.create') }}" class="btn btn-sm fw-bold btn-primary">
                            Create
                        </a>
                    @endif
                </div>
    ...
    <script>
        ...
        $(function () {
            ...
            var table = $('#data-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('portal.job-category.index') }}",
                columns: [
                    {
                        data: 'id',
                        name: 'id',
