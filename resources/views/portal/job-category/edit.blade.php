@extends('layouts.admin', ['title' => 'Update Job Category Information'])
@push('style')
    ...
    <div class="d-flex flex-column flex-column-fluid">
            ...
            <div id="app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <li class="breadcrumb-item text-muted">Update Job Category Information</li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div id="app_content" class="app-content flex-column-fluid">
            <div id="app_content_container" class="app-container container-xxl">
                <div class="card">
                    <div class="card-body">
                        <form data-editor="description" action="{{ route('portal.job-category.update', $model->uuid) }}" method="POST" enctype="multipart/form-data" class="content_form">
                            @method('PATCH')
                            <div class="row">
                                ...
                                @if(Auth::guard('admin')->user()->hasPermissionTo('job_category.update'))
                                    <div class="col-md-12 mb-3 text-center">
                                        <button type="submit" class="btn btn-sm btn-block btn-primary" id="submit">
                                            <i class="fas fa-paper-plane fa-fw"></i> Update Job Category    
                                        </button>
