                ...
                $questions = Question::with(['options', 'passage', 'category', 'job_category', 'exam'])
                    ...
                    ->map(function ($q) {
                        return [
                            ...
                            'content' => $q->content,
                            'options' => [
                                $q->options ? $q->options->option_one : '',
                                $q->options ? $q->options->option_two : '',
                                $q->options ? $q->options->option_three : '',
                                $q->options ? $q->options->option_four : '',
                                $q->options ? $q->options->option_five : null,
                            ],
                            'category_name' => $q->category?->name,
                            'category_slug' => $q->category?->slug,
                            'exam_name' => $q->job_category?->name,
